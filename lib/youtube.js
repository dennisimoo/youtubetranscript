...
async function getTranscript(videoId) {
  try {
    ...
    // Download VTT subtitle file using yt-dlp
    const ytdlpCmd = `yt-dlp --write-subs --write-auto-subs --sub-langs en --sub-format vtt --skip-download -o "${outputTemplate}" "${videoUrl}"`;
